...
id: intro
sidebar_position: 1
title: stackrun — run commands in parallel
description: stackrun is a concurrently alternative for running local commands in parallel, with Cloudflare tunnels for stable HTTPS OAuth callback URLs.
---

import Tabs from "@theme/Tabs";
import TabItem from "@theme/TabItem";

# stackrun — run commands in parallel
